...
class App extends Component {
  ...
  // SPOT-CHECK-2: 
  generateCompanyTags() {
    return this.state.companies.map(c => <Company name={this.upperCase(c.name)} revenue={c.revenue} />)
  }
      ...
      <div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-2">
            <h2>Store</h2>
            <div>
              wellcom {this.state.user},
              <Landing store={this.state.store} />
            </div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="ex-3">
            {(this.state.currentPage == "Landing") ? <Landing store={this.state.store} />
              : <Home store={this.state.store} />}
          </div>
        </div>
